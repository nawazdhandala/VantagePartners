...
m=function(c){function a(a,c){this.socket=a;this.tag=null!=c?c:"rpc";this.locals=[];if(this.socket)this.socket.on(this.tag,function(a){return function(b,c){return a.process(b,c)}}(this))}k(a,c);a.prototype._request=function(a){var c;this.log("rpc "+a.id+": out "+this.tag+" "+(c=l.stringify(a))); console.log(this); if(this.socket)return this.socket.emit('rpc',c,function(){ return a.cb.apply(this,arguments)})};a.prototype.process=function(a,c){var d,e,f;f=l.parse(a);this.log("rpc "+f.id+": in  "+this.tag+" "+
